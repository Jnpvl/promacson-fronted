              ...
              <div className={heroSlideFrameClass}>
                {slide.imageUrl ? (
                  <>
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-black/75 via-black/40 to-black/15 sm:from-black/60 sm:via-black/30 sm:to-transparent" />
                  </>
                ) : (
                  <>
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-4 pb-5 sm:justify-center sm:p-6 sm:pb-14 lg:px-10 lg:pb-16">
